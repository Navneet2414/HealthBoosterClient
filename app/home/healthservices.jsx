    ...
    <section className="bg-[#f8fbff] py-20">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-3">
          {/* Doctor Appointments */}
          <Link href="/doctor" className="bg-white rounded-xl shadow-md p-8 flex flex-col justify-between h-[420px] hover:shadow-lg transition-shadow">
            <div>
            ...
            <div className="mt-6 w-full border-2 border-blue-500 text-blue-600 font-semibold py-2 rounded-lg hover:bg-blue-50">
              Book Appointment →
            </div>
          </Link>
          {/* Lab Tests */}
          <Link href="/laboratory" className="bg-white rounded-xl shadow-md p-8 flex flex-col justify-between h-[420px] hover:shadow-lg transition-shadow">
            <div>
              <div className="flex justify-center">
                <div className="bg-gradient-to-r from-blue-500 to-green-400 text-white rounded-2xl p-4 shadow-md">
                  <FaFlask size={32} />
          ...
          {/* Medicine Delivery */}
          <Link href="/order-medicine" className="bg-white rounded-xl shadow-md p-8 flex flex-col justify-between h-[420px] hover:shadow-lg transition-shadow">
            <div>
              <div className="flex justify-center">
                <div className="bg-gradient-to-r from-blue-500 to-green-400 text-white rounded-2xl p-4 shadow-md">
                  <FaPills size={32} />
