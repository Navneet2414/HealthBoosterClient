...
//           {cards.map(({ title, Icon, signupHref }, idx) => (
//             <motion.div
//               key={title}
...
//             >
//               <Link href={signupHref} className="block h-full">
...
//                   {/* Continue Button */}
//                   <div className="inline-flex items-center justify-center rounded-xl px-6 py-3 font-medium bg-white/20 hover:bg-white/30 backdrop-blur transition focus:outline-none focus:ring-2 focus:ring-white/60">
//                     Continue
//                   </div>
//                 </div>
//               </Link>
...
import SignupPortal from "@/components/SignUp/signUp";  
