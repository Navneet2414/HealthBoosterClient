...
import { FaImage, FaUser, FaEye, FaEyeSlash } from "react-icons/fa";
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full rounded-lg border border-gray-300 px-4 py-2 pr-10 text-gray-900 focus:border-green-500 focus:ring-2 focus:ring-green-500"
                placeholder="••••••••"
              />
              <button
                type="button"
